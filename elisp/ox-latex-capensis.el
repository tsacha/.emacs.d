;;; ox-latex-capensis.el --- LaTeX Back-End for Org Export Engine with 
;;; minor modifications

;; Copyright (C) 2015 Sacha Trémoureux
...
(org-export-define-backend 'latex-capensis
  '((bold . org-latex-capensis-bold)
    (center-block . org-latex-capensis-center-block)
    (clock . org-latex-capensis-clock)
    (code . org-latex-capensis-code)
    (comment . (lambda (&rest args) ""))
    (comment-block . (lambda (&rest args) ""))
    (drawer . org-latex-capensis-drawer)
    (dynamic-block . org-latex-capensis-dynamic-block)
    (entity . org-latex-capensis-entity)
    (example-block . org-latex-capensis-example-block)
    (export-block . org-latex-capensis-export-block)
    (export-snippet . org-latex-capensis-export-snippet)
    (fixed-width . org-latex-capensis-fixed-width)
    (footnote-definition . org-latex-capensis-footnote-definition)
    (footnote-reference . org-latex-capensis-footnote-reference)
    (headline . org-latex-capensis-headline)
    (horizontal-rule . org-latex-capensis-horizontal-rule)
    (inline-src-block . org-latex-capensis-inline-src-block)
    (inlinetask . org-latex-capensis-inlinetask)
    (italic . org-latex-capensis-italic)
    (item . org-latex-capensis-item)
    (keyword . org-latex-capensis-keyword)
    (latex-environment . org-latex-capensis-latex-environment)
    (latex-fragment . org-latex-capensis-latex-fragment)
    (line-break . org-latex-capensis-line-break)
    (link . org-latex-capensis-link)
    (node-property . org-latex-capensis-node-property)
    (paragraph . org-latex-capensis-paragraph)
    (plain-list . org-latex-capensis-plain-list)
    (plain-text . org-latex-capensis-plain-text)
    (planning . org-latex-capensis-planning)
    (property-drawer . org-latex-capensis-property-drawer)
    (quote-block . org-latex-capensis-quote-block)
    (radio-target . org-latex-capensis-radio-target)
    (section . org-latex-capensis-section)
    (special-block . org-latex-capensis-special-block)
    (src-block . org-latex-capensis-src-block)
    (statistics-cookie . org-latex-capensis-statistics-cookie)
    (strike-through . org-latex-capensis-strike-through)
    (subscript . org-latex-capensis-subscript)
    (superscript . org-latex-capensis-superscript)
    (table . org-latex-capensis-table)
    (table-cell . org-latex-capensis-table-cell)
    (table-row . org-latex-capensis-table-row)
    (target . org-latex-capensis-target)
    (template . org-latex-capensis-template)
    (timestamp . org-latex-capensis-timestamp)
    (underline . org-latex-capensis-underline)
    (verbatim . org-latex-capensis-verbatim)
    (verse-block . org-latex-capensis-verse-block)
    ;; Pseudo objects and elements.
    (latex-math-block . org-latex-capensis-math-block)
    (latex-matrices . org-latex-capensis-matrices))
  ...
  '((:latex-class "LATEX_CLASS" nil org-latex-capensis-default-class t)
    ...
    ;; Other variables.
    (:latex-active-timestamp-format nil nil org-latex-capensis-active-timestamp-format)
    (:latex-caption-above nil nil org-latex-capensis-caption-above)
    (:latex-classes nil nil org-latex-capensis-classes)
    (:latex-custom-id-labels nil nil org-latex-capensis-custom-id-as-label)
    (:latex-default-figure-position nil nil org-latex-capensis-default-figure-position)
    (:latex-default-table-environment nil nil org-latex-capensis-default-table-environment)
    (:latex-default-table-mode nil nil org-latex-capensis-default-table-mode)
    (:latex-diary-timestamp-format nil nil org-latex-capensis-diary-timestamp-format)
    (:latex-footnote-separator nil nil org-latex-capensis-footnote-separator)
    (:latex-format-drawer-function nil nil org-latex-capensis-format-drawer-function)
    (:latex-format-headline-function nil nil org-latex-capensis-format-headline-function)
    (:latex-format-inlinetask-function nil nil org-latex-capensis-format-inlinetask-function)
    (:latex-hyperref-template nil nil org-latex-capensis-hyperref-template t)
    (:latex-image-default-height nil nil org-latex-capensis-image-default-height)
    (:latex-image-default-option nil nil org-latex-capensis-image-default-option)
    (:latex-image-default-width nil nil org-latex-capensis-image-default-width)
    (:latex-inactive-timestamp-format nil nil org-latex-capensis-inactive-timestamp-format)
    (:latex-inline-image-rules nil nil org-latex-capensis-inline-image-rules)
    (:latex-link-with-unknown-path-format nil nil org-latex-capensis-link-with-unknown-path-format)
    (:latex-listings nil nil org-latex-capensis-listings)
    (:latex-listings-langs nil nil org-latex-capensis-listings-langs)
    (:latex-listings-options nil nil org-latex-capensis-listings-options)
    (:latex-minted-langs nil nil org-latex-capensis-minted-langs)
    (:latex-minted-options nil nil org-latex-capensis-minted-options)
    (:latex-table-scientific-notation nil nil org-latex-capensis-table-scientific-notation)
    (:latex-tables-booktabs nil nil org-latex-capensis-tables-booktabs)
    (:latex-tables-centered nil nil org-latex-capensis-tables-centered)
    (:latex-text-markup-alist nil nil org-latex-capensis-text-markup-alist)
    (:latex-title-command nil nil org-latex-capensis-title-command)
    (:latex-toc-command nil nil org-latex-capensis-toc-command)
...
(defconst org-latex-capensis-babel-language-alist
  '(("af" . "afrikaans")
    ("bg" . "bulgarian")
    ("bt-br" . "brazilian")
    ("ca" . "catalan")
...
(defcustom org-latex-capensis-caption-above '(table)
...
(defcustom org-latex-capensis-default-class "article"
  "The default LaTeX class."
  :group 'org-export-latex
  :type '(string :tag "LaTeX class"))

(defcustom org-latex-capensis-classes
  '(("article"
...
`org-latex-capensis-inputenc-alist' for a way to influence this mechanism.
...
(defcustom org-latex-capensis-toc-command "\\tableofcontents\n\n"
...
(defcustom org-latex-capensis-hyperref-template
  "\\hypersetup{\n pdfkeywords={%k},\n  pdfsubject={%d},\n  pdfcreator={%c}}\n"
...
(defcustom org-latex-capensis-format-headline-function
  'org-latex-capensis-format-headline-default-function
...
(defcustom org-latex-capensis-footnote-separator "\\textsuperscript{,}\\,"
...
(defcustom org-latex-capensis-active-timestamp-format "\\textit{%s}"
  "A printf format string to be applied to active timestamps."
  :group 'org-export-latex
  :type 'string)

(defcustom org-latex-capensis-inactive-timestamp-format "\\textit{%s}"
  "A printf format string to be applied to inactive timestamps."
  :group 'org-export-latex
  :type 'string)

(defcustom org-latex-capensis-diary-timestamp-format "\\textit{%s}"
...
(defcustom org-latex-capensis-image-default-option ""
...
(defcustom org-latex-capensis-image-default-width ".9\\linewidth"
...
(defcustom org-latex-capensis-image-default-height ""
...
(defcustom org-latex-capensis-default-figure-position "htb"
  "Default position for latex figures."
  :group 'org-export-latex
  :type 'string)

(defcustom org-latex-capensis-inline-image-rules
...
(defcustom org-latex-capensis-default-table-environment "tabular"
...
(defcustom org-latex-capensis-default-table-mode 'table
...
`org-latex-capensis-default-table-environment' accordingly."
  :group 'org-export-latex
  :version "24.4"
  :package-version '(Org . "8.0")
...
(defcustom org-latex-capensis-tables-booktabs nil
...
(defcustom org-latex-capensis-table-scientific-notation "%s\\,(%s)"
...
(defcustom org-latex-capensis-format-drawer-function
...
(defcustom org-latex-capensis-format-inlinetask-function
  'org-latex-capensis-format-inlinetask-default-function
...
(defcustom org-latex-capensis-listings nil
...
`org-latex-capensis-pdf-process' so that the -shell-escape option is
passed to pdflatex.
...
value.  For example,
  ...
  \(setq org-latex-capensis-listings-options
    '((\"basicstyle\" \"\\\\small\")
...
latex packages.  For example,
  ...
  \(setq org-latex-capensis-custom-lang-environments
     '\(\(python \"pythoncode\"\)\)\)
...
(defcustom org-latex-capensis-pdf-process
...
The logfiles will be remove if `org-latex-capensis-remove-logfiles' is
non-nil."
  :group 'org-export-latex
  :type '(repeat (string :tag "Extension")))

(defcustom org-latex-capensis-remove-logfiles t
  "Non-nil means remove the logfiles produced by PDF production.
By default, logfiles are files with these extensions: .aux, .idx,
.log, .out, .toc, .nav, .snm and .vrb.  To define the set of
logfiles to remove, set `org-latex-capensis-logfiles-extensions'."
  :group 'org-export-latex
  :type 'boolean)

(defcustom org-latex-capensis-known-warnings
...
calling `org-latex-capensis-compile'."
  :group 'org-export-latex
  :version "25.1"
  :package-version '(Org . "8.3")
  :type '(repeat
...
(defun org-latex-capensis--caption-above-p (element info)
...
(defun org-latex-capensis-guess-inputenc (header)
...
`org-latex-capensis--caption/label-string'."
  (let ((label (org-element-property :name element)))
...
`org-latex-capensis-text-markup-alist' for details."
...
(defun org-latex-capensis--delayed-footnotes-definitions (element info)
...
(defun org-latex-capensis--translate (s info)
...
(defun org-latex-capensis-template (contents info)
  ...
  (let ((title (org-export-data (plist-get info :title) info)))
    (concat
     ...
     ;; Title
		 (format "\\title{%s}\n" title)
     ;; Client
		 (let ((client (plist-get info :client)))
			 (format "\\client{%s}\n" client))
     ;; Logoclient
		 (let ((logoclient (plist-get info :logoclient)))
			 (format "\\logoclient{%s}\n" logoclient))		 
     ;; Destinataire
		 (let ((destinataire (plist-get info :destinataire)))
			 (format "\\destinataire{%s}\n" destinataire))
     ;; Typedoc
...
(defun org-latex-capensis-bold (bold contents info)
  "Transcode BOLD from Org to LaTeX.
CONTENTS is the text with bold markup.  INFO is a plist holding
contextual information."
  (org-latex-capensis--text-markup contents 'bold info))


;;;; Center Block

(defun org-latex-capensis-center-block (center-block contents info)
...
(defun org-latex-capensis-clock (clock contents info)
...
(defun org-latex-capensis-code (code contents info)
  "Transcode a CODE object from Org to LaTeX.
CONTENTS is nil.  INFO is a plist used as a communication
channel."
  (org-latex-capensis--text-markup (org-element-property :value code) 'code info))


;;;; Drawer

(defun org-latex-capensis-drawer (drawer contents info)
...
(defun org-latex-capensis-dynamic-block (dynamic-block contents info)
  "Transcode a DYNAMIC-BLOCK element from Org to LaTeX.
CONTENTS holds the contents of the block.  INFO is a plist
holding contextual information.  See `org-export-data'."
  (org-latex-capensis--wrap-label dynamic-block contents))


;;;; Entity

(defun org-latex-capensis-entity (entity contents info)
...
(defun org-latex-capensis-example-block (example-block contents info)
...
(defun org-latex-capensis-export-block (export-block contents info)
...
(defun org-latex-capensis-export-snippet (export-snippet contents info)
...
(defun org-latex-capensis-fixed-width (fixed-width contents info)
...
(defun org-latex-capensis-footnote-reference (footnote-reference contents info)
...
(defun org-latex-capensis-headline (headline contents info)
...
(defun org-latex-capensis-horizontal-rule (horizontal-rule contents info)
...
(defun org-latex-capensis-inline-src-block (inline-src-block contents info)
...
(defun org-latex-capensis-inlinetask (inlinetask contents info)
...
(defun org-latex-capensis-italic (italic contents info)
  "Transcode ITALIC from Org to LaTeX.
CONTENTS is the text with italic markup.  INFO is a plist holding
contextual information."
  (org-latex-capensis--text-markup contents 'italic info))


;;;; Item

(defun org-latex-capensis-item (item contents info)
...
(defun org-latex-capensis-keyword (keyword contents info)
...
(defun org-latex-capensis-latex-environment (latex-environment contents info)
...
(defun org-latex-capensis-latex-fragment (latex-fragment contents info)
...
(defun org-latex-capensis-line-break (line-break contents info)
...
(defun org-latex-capensis--inline-image (link info)
...
(defun org-latex-capensis-node-property (node-property contents info)
...
(defun org-latex-capensis-paragraph (paragraph contents info)
...
(defun org-latex-capensis-plain-list (plain-list contents info)
...
(defun org-latex-capensis-plain-text (text info)
...
(defun org-latex-capensis-planning (planning contents info)
...
(defun org-latex-capensis-property-drawer (property-drawer contents info)
...
(defun org-latex-capensis--wrap-latex-matrices (data info)
...
(defun org-latex-capensis-matrices (matrices contents info)
...
(defun org-latex-capensis--wrap-latex-math-block (data info)
...
(defun org-latex-capensis-math-block-tree-filter (tree backend info)
  (org-latex-capensis--wrap-latex-math-block tree info))
...
(defun org-latex-capensis-quote-block (quote-block contents info)
...
(defun org-latex-capensis-radio-target (radio-target text info)
...
(defun org-latex-capensis-section (section contents info)
...
(defun org-latex-capensis-special-block (special-block contents info)
...
(defun org-latex-capensis-src-block (src-block contents info)
...
(defun org-latex-capensis-statistics-cookie (statistics-cookie contents info)
...
(defun org-latex-capensis-strike-through (strike-through contents info)
  "Transcode STRIKE-THROUGH from Org to LaTeX.
CONTENTS is the text with strike-through markup.  INFO is a plist
holding contextual information."
  (org-latex-capensis--text-markup contents 'strike-through info))


;;;; Subscript

(defun org-latex-capensis--script-size (object info)
...
contextual information."
  (org-latex-capensis--script-size subscript info))


;;;; Superscript

(defun org-latex-capensis-superscript (superscript contents info)
  "Transcode a SUPERSCRIPT object from Org to LaTeX.
CONTENTS is the contents of the object.  INFO is a plist holding
contextual information."
  (org-latex-capensis--script-size superscript info))


;;;; Table
;;
;; `org-latex-capensis-table' is the entry point for table transcoding.  It
;; takes care of tables with a "verbatim" mode.  Otherwise, it
;; delegates the job to either `org-latex-capensis--table.el-table',
;; `org-latex-capensis--org-table' or `org-latex-capensis--math-table' functions,
;; depending of the type of the table and the mode requested.
;;
;; `org-latex-capensis--align-string' is a subroutine used to build alignment
;; string for Org tables.

(defun org-latex-capensis-table (table contents info)
...
(defun org-latex-capensis-table-cell (table-cell contents info)
...
(defun org-latex-capensis-table-row (table-row contents info)
...
(defun org-latex-capensis-target (target contents info)
...
(defun org-latex-capensis-timestamp (timestamp contents info)
...
(defun org-latex-capensis-underline (underline contents info)
  "Transcode UNDERLINE from Org to LaTeX.
CONTENTS is the text with underline markup.  INFO is a plist
holding contextual information."
  (org-latex-capensis--text-markup contents 'underline info))


;;;; Verbatim

(defun org-latex-capensis-verbatim (verbatim contents info)
  "Transcode a VERBATIM object from Org to LaTeX.
CONTENTS is nil.  INFO is a plist used as a communication
channel."
  (org-latex-capensis--text-markup
   (org-element-property :value verbatim) 'verbatim info))


;;;; Verse Block

(defun org-latex-capensis-verse-block (verse-block contents info)
...
is non-nil."
  (interactive)
  (org-export-to-buffer 'latex-capensis "*Org LATEX Export*"
    async subtreep visible-only body-only ext-plist (lambda () (LaTeX-mode))))

;;;###autoload
(defun org-latex-capensis-convert-region-to-latex ()
...
file-local settings."
  ...
  (let ((outfile (org-export-output-file-name ".tex" subtreep)))
    (org-export-to-file 'latex-capensis outfile
...
Return PDF file's name."
  ...
  (let ((outfile (org-export-output-file-name ".tex" subtreep)))
    (org-export-to-file 'latex-capensis outfile
      async subtreep visible-only body-only ext-plist
      (lambda (file) (org-latex-capensis-compile file)))))

(defun org-latex-capensis-compile (texfile &optional snippet)
  "Compile a TeX file.

TEXFILE is the name of the file being compiled.  Processing is
done through the command specified in `org-latex-capensis-pdf-process'.
...
;;;###autoload
(defun org-latex-capensis-publish-to-pdf (plist filename pub-dir)
...
Return output file name."
  ;; Unlike to `org-latex-capensis-publish-to-latex', PDF file is generated
  ;; in working directory and then moved to publishing directory.
  (org-publish-attachment
   plist
   (org-latex-capensis-compile
    (org-publish-org-to
     'latex filename ".tex" plist (file-name-directory filename)))
   pub-dir))


(provide 'ox-latex-capensis)
