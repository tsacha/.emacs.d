...
#+BEGIN_SRC emacs-lisp 
  (mapcar
   ...
   '((?s . "~/.emacs.d/sacha.org")
     (?b . "~/Documents/Org mode/bidouille.org")
     (?w . "~/Documents/Org mode/work.org")
     (?p . "~/Documents/Org mode/perso.org")))
#+END_SRC
** Packages
*** Org
...
#+BEGIN_SRC emacs-lisp
  (use-package org
    ...
    (setq org-agenda-files (list "~/Documents/Org mode/perso.org"
                                 "~/Documents/Org mode/bidouille.org" 
                                 "~/Documents/Org mode/work.org"))
